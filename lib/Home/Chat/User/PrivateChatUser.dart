...
import 'package:untitled7/Class/MessageController.dart';
import 'package:untitled7/Class/UserController.dart';
import 'package:untitled7/Constant/Allcolor.dart';
import 'package:untitled7/FunctionDatabase/ChatAdminData.dart';
import 'package:untitled7/FunctionDatabase/functionHomeadmin.dart';

import '../../../main.dart';

late String ID;

class PrivateChatUser extends StatefulWidget {
  final int index;

  PrivateChatUser(this.index);

  @override
  _PrivateChatUserState createState() => _PrivateChatUserState();
}

class _PrivateChatUserState extends State<PrivateChatUser> {
  final TextEditingController _textController = TextEditingController();
  final MessageController messageController = Get.put(MessageController());
  final UserController controller1 = Get.put(UserController());
  ...
  void initState() {
    super.initState();
    print('Controller data length: ${controller.data.length}');
    print('Widget index: ${widget.index}');
      String receiverId = controller1.dataList[widget.index]['id'].toString();
                ...
                children: <Widget>[
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      fetchMessages(ID);
                      controller1.fetchDataUserList(ID);
                    },
                  ),
                ],
              ),
